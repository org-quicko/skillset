 ...
 * reader it started in: `sqillset add` checks every entry of a downloaded
 ...
 * upload, to the API validating a declared manifest, and to `sqillset add`
 ...
 * one — `sqillset add`, the web Download control, and a marketplace
