...
import { ResourceDirectoryQuerySchema, type ResourceDirectoryQuery } from "./resource-directory-query.js";
...
/**
 * Drives `ResourceDirectoryQuerySchema` through a real request, with the API's
 ...
 */
const app = new Hono()
  .get("/resources", validate("query", ResourceDirectoryQuerySchema), (c) => c.json(c.req.valid("query")))
...
describe("ResourceDirectoryQuerySchema — defaults", () => {
...
describe("ResourceDirectoryQuerySchema — page", () => {
...
describe("ResourceDirectoryQuerySchema — page_size", () => {
...
describe("ResourceDirectoryQuerySchema — q", () => {
...
describe("ResourceDirectoryQuerySchema — kind", () => {
...
describe("ResourceDirectoryQuerySchema — tag_id", () => {
...
describe("ResourceDirectoryQuerySchema — sorting", () => {
