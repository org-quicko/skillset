...
import { type AgentDetection, detectAgent, nonUniversalProjectSkillsDirs } from "@in-org-quicko/sqillset-shared";
import type { InstallContext } from "@in-org-quicko/sqillset-installer";
